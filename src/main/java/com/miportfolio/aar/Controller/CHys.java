...
import com.miportfolio.aar.Dto.dtohys;
import com.miportfolio.aar.Entity.hys;
import com.miportfolio.aar.Security.Controller.Mensaje;
import com.miportfolio.aar.Service.Shys;
...
@CrossOrigin(origins = "http://localhost:4200")//luego poner el url del front end
public class CHys {
    @Autowired
    Shys shys;
